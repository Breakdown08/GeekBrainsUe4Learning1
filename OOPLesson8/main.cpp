...
{
    //в setw аргумент подложить длину строки самой длинной фамилии, также имени и отчества, должно заработать, вызвать функцией
    os << std::setw(20) << p.LastName << " " << p.FirstName;
    if (p.Patronymic)
    {
        os << " " << *p.Patronymic;
    }
